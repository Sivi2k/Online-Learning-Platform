...
public class SecurityController {
    ...
    public SecurityController(UserRepository userRepository, EnrollmentRepository enrollmentRepository,
			UserService userService , AuthGroupRepository authGroupRepository ) {
		super();
    ...
    public String getUserProfile(Authentication authentication, Model model)  {
        try {
			...
			try {
				authGroups = this.authGroupRepository.findByUsername(currentUsername);
    ...
    public String getForEdit(@PathVariable Long userID, Authentication authentication, Model model) {
        ...
        try {
            ...
            return "user/user-edit";
                ...
                throw new Exception("Error IN autenticacion");
            }
        } catch (Exception e) {
            e.printStackTrace();
            model.addAttribute("error", e);
